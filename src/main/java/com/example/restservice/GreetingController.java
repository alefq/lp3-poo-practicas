...
public class GreetingController {
	...
	public Greeting greetPerson(@RequestBody Persona persona) {
		Tracker.rastrear(persona);
		return new FormalGreeting(counter.incrementAndGet(), String.format(template, persona.getNombre()));
	}
